    ...
    >
      <div className={`text-white flex justify-between items-center`}>
        <h1 className="font-bold p-4  md:ml-6 border-gray-200 flex">
          ...
          <Link to="/" className="block md:hidden ml-1">becomeIngenious</Link>
        </h1>
        <button
          className="px-4 cursor-pointer md:hidden rounded-3xl hover:bg-gray-300"
          id="dropdown"
      ...
      >
        <Link
          to="/"
          className="font-bold m-4 p-2 flex hover:bg-blue-200 hover:text-black rounded transition ease-out duration-500 hover:scale-105"
